...
static void SDA_OUT(void) {
  GPIO_InitTypeDef g = {0}; g.Pin = GPIO_PIN_5; g.Mode = GPIO_MODE_OUTPUT_PP;
  g.Pull = GPIO_NOPULL; g.Speed = GPIO_SPEED_FREQ_VERY_HIGH; HAL_GPIO_Init(GPIOB, &g);
}
static void SDA_IN(void) {
  GPIO_InitTypeDef g = {0}; g.Pin = GPIO_PIN_5; g.Mode = GPIO_MODE_INPUT;
  g.Pull = GPIO_PULLUP; HAL_GPIO_Init(GPIOB, &g);
}
