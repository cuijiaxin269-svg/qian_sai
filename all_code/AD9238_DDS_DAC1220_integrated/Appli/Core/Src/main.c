...
volatile uint32_t g_dac1220_4v_start_tick;
volatile bool g_dac1220_5v_written;
...
int main(void)
{
  ...
  (void)DAC1220_Init();
  HAL_Delay(500u);
  DAC1220VolWrite(4.000f);
  g_dac1220_4v_start_tick = HAL_GetTick();
  g_dac1220_5v_written = false;
  g_boot_stage = 8u;
  AD9238_Init();
  g_boot_stage = 9u;
  DDS_AD9833_Init();
  ...
  while (1)
  {
    ...
    if ((!g_dac1220_5v_written) &&
        ((HAL_GetTick() - g_dac1220_4v_start_tick) >= 10000u))
    {
      DAC1220VolWrite(5.000f);
      g_dac1220_5v_written = true;
    }
