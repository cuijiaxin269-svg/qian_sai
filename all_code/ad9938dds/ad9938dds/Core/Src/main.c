...
#define AD9833_CS_LOW()    HAL_GPIO_WritePin(AD9833_CS_PORT, AD9833_CS_PIN, GPIO_PIN_RESET)
#define AD9833_CS_HIGH()   HAL_GPIO_WritePin(AD9833_CS_PORT, AD9833_CS_PIN, GPIO_PIN_SET)
